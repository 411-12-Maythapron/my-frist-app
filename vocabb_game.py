...
st.title("⏱️ เกมเติมศัพท์จับเวลา หมวดอาหารและขนม")
...
def show_result_dialog(ans1, ans2):
    ...
    # ตรวจข้อ 2
    if u_ans2 == "fried rice":
        st.success("✅ ข้อ 2: ถูกต้อง")
        score += 1
    else:
        st.error(f"❌ ข้อ 2: ยังไม่ถูกต้อง (คุณตอบ '{u_ans2}')")
    # ตรวจข้อ 3
    if u_ans3 == "grilled chicken":
...
ans1 = st.text_input(
    "ข้อ 1: p _ p _ y a s _ l _ d. 🥗 🌶️",
    value=st.session_state.ans1_val,
)
ans2 = st.text_input(
    "ข้อ 2: f r _ _ d r _ c e. 🍚🍳",
    value=st.session_state.ans2_val,
)
ans3 = st.text_input(
    "ข้อ 3: g _ _ l l _ d c h _ c k _ n. 🍗",
    value=st.session_state.ans3_val,
)
ans4 = st.text_input(
    "ข้อ 4: S _ a_ e d i _ e. 🍨",
